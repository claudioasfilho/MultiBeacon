...
static const gecko_configuration_t config = {
  ...
  /* STEP 1
   * Modify Max number of Advertisers */
...
/* STEP 2
   * This Handler will hold the two Beacon Handlers
...
void bcnSetupAdvBeaconing(void)
{
  ...
  bcnBeaconAdvData
    ...
    { UINT16_TO_BYTE1(33333), UINT16_TO_BYTE0(33333) },

    /* Beacon minor number */
    /* Set as 1025 and converted to correct format */
    { UINT16_TO_BYTE1(444), UINT16_TO_BYTE0(444) },
